  ...
  return (
    <div className=" text-green-400 p-[18px] flex items-center justify-between text-[18px] backdrop-blur-md  sticky top-0 left-0 right-0 z-50	max-w-[81rem] mx-auto">
      ...
      ${slideMenu ? 'h-[255px]' : 'h-0 overflow-hidden'}
        `}>
        <a className="px-[18px] py-3 md:p-2 relative navItems group cursor-pointer my-auto" href="#home">Home</a>
        <a className="relative navItems group cursor-pointer px-[18px] py-3 md:p-2" href="#about">About</a>
        <a className="relative navItems group cursor-pointer px-[18px] py-3 md:p-2" href="#skills">Skills</a>
        <a className="relative navItems group cursor-pointer px-[18px] py-3 md:p-2" href="#projects">Projects</a>
        <a className="relative navItems group cursor-pointer px-[18px] py-3 md:p-2" href="#contact">Contact</a>
      </div>
